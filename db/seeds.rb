...
shoe_photos = [stockx_photos.sample, stockx_photos.sample, stockx_photos.sample]

file = URI.open(shoe_photos[0])
file2 = URI.open(shoe_photos[1])
file3 = URI.open(shoe_photos[2])
  shoe = Shoe.create(
...
shoe.image1.attach(io: file, filename: 'image1', content_type: 'image/png')
shoe.image2.attach(io: file2, filename: 'image2', content_type: 'image/png')
shoe.image3.attach(io: file3, filename: 'image3', content_type: 'image/png')
end
