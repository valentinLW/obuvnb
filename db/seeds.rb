...
marina = User.new(first_name: 'Marina',
        last_name: "Miranda",
...
marina.profile_picture.attach(io: file, filename: 'profile_picture.png', content_type: 'image/png')
marina.save!

file = URI.open('https://res.cloudinary.com/wagon/image/upload/c_fill,g_face,h_200,w_200/v1626805000/yppphiokhswqo7b4ar1b.jpg')
vale = User.new(first_name: 'Valentin',
        last_name: "Hobusch",
...
vale.profile_picture.attach(io: file, filename: 'profile_picture.png', content_type: 'image/png')
vale.save!

file = URI.open('https://res.cloudinary.com/wagon/image/upload/c_fill,g_face,h_200,w_200/v1625037044/xyvhwprahklgd6nke6rd.jpg')
stan = User.new(first_name: 'Stanislaw',
        last_name: "Novikow",
...
ruy.profile_picture.attach(io: file, filename: 'profile_picture.png', content_type: 'image/png')
ruy.save!
...
dunkgreen = %w[
  ...
  https://images.stockx.com/360/Nike-Dunk-Low-Green-Glow-W/Images/Nike-Dunk-Low-Green-Glow-W/Lv2/img13.jpg?auto=compress&dpr=2&updated_at=1619204705&fit=clip&fm=webp&ixlib=react-9.1.5&q=90&w=1140
  https://images.stockx.com/360/Nike-Dunk-Low-Green-Glow-W/Images/Nike-Dunk-Low-Green-Glow-W/Lv2/img31.jpg?auto=compress&dpr=2&updated_at=1619204705&fit=clip&fm=webp&ixlib=react-9.1.5&q=90&w=1140
  https://images.stockx.com/360/Nike-Dunk-Low-Green-Glow-W/Images/Nike-Dunk-Low-Green-Glow-W/Lv2/img21.jpg?auto=compress&dpr=2&updated_at=1619204705&fit=clip&fm=webp&ixlib=react-9.1.5&q=90&w=1140
]

nikegore = %w[
  https://images.stockx.com/360/Nike-Air-Force-1-High-GTX-Boot-Flax/Images/Nike-Air-Force-1-High-GTX-Boot-Flax/Lv2/img01.jpg?auto=compress&dpr=2&updated_at=1609362159&fit=clip&fm=webp&ixlib=react-9.1.5&q=90&w=1140
  https://images.stockx.com/360/Nike-Air-Force-1-High-GTX-Boot-Flax/Images/Nike-Air-Force-1-High-GTX-Boot-Flax/Lv2/img32.jpg?auto=compress&dpr=2&updated_at=1609362159&fit=clip&fm=webp&ixlib=react-9.1.5&q=90&w=1140
  https://images.stockx.com/360/Nike-Air-Force-1-High-GTX-Boot-Flax/Images/Nike-Air-Force-1-High-GTX-Boot-Flax/Lv2/img22.jpg?auto=compress&dpr=2&updated_at=1609362159&fit=clip&fm=webp&ixlib=react-9.1.5&q=90&w=1140
  https://images.stockx.com/360/Nike-Air-Force-1-High-GTX-Boot-Flax/Images/Nike-Air-Force-1-High-GTX-Boot-Flax/Lv2/img14.jpg?auto=compress&dpr=2&updated_at=1609362159&fit=clip&fm=webp&ixlib=react-9.1.5&q=90&w=1140
]

docm = %w[
  https://images.stockx.com/360/Dr-Martens-1460-Bex-Leather-Boot-Rick-Owens/Images/Dr-Martens-1460-Bex-Leather-Boot-Rick-Owens/Lv2/img01.jpg?auto=compress&dpr=2&updated_at=1618344027&fit=clip&fm=webp&ixlib=react-9.1.5&q=90&w=1140
  https://images.stockx.com/360/Dr-Martens-1460-Bex-Leather-Boot-Rick-Owens/Images/Dr-Martens-1460-Bex-Leather-Boot-Rick-Owens/Lv2/img14.jpg?auto=compress&dpr=2&updated_at=1618344027&fit=clip&fm=webp&ixlib=react-9.1.5&q=90&w=1140
  https://images.stockx.com/360/Dr-Martens-1460-Bex-Leather-Boot-Rick-Owens/Images/Dr-Martens-1460-Bex-Leather-Boot-Rick-Owens/Lv2/img25.jpg?auto=compress&dpr=2&updated_at=1618344027&fit=clip&fm=webp&ixlib=react-9.1.5&q=90&w=1140
  https://images.stockx.com/360/Dr-Martens-1460-Bex-Leather-Boot-Rick-Owens/Images/Dr-Martens-1460-Bex-Leather-Boot-Rick-Owens/Lv2/img15.jpg?auto=compress&dpr=2&updated_at=1618344027&fit=clip&fm=webp&ixlib=react-9.1.5&q=90&w=1140
  https://images.stockx.com/360/Dr-Martens-1460-Bex-Leather-Boot-Rick-Owens/Images/Dr-Martens-1460-Bex-Leather-Boot-Rick-Owens/Lv2/img09.jpg?auto=compress&dpr=2&updated_at=1618344027&fit=clip&fm=webp&ixlib=react-9.1.5&q=90&w=1140
]
...
5.times do |index|
  puts "creating shoe size 38.0 random #{index + 1}/5"
  file = URI.open(stockx_photos.sample)
  file2 = URI.open(stockx_photos.sample)
  file3 = URI.open(stockx_photos.sample)
  shoe = Shoe.create(
...
puts "creating shoe size 38.0  for stan"
file = URI.open(dunkgreen[0])
file2 = URI.open(dunkgreen[1])
file3 = URI.open(dunkgreen[2])
shoe = Shoe.create(
  model: "Nike Dunk Low Green Glow",
  price: 7,
  size: 38.0,
...
puts "creating shoe size 38.0  for vale"
file = URI.open(docm[0])
file2 = URI.open(docm[1])
file3 = URI.open(docm[2])
file4 = URI.open(docm[3])
shoe = Shoe.create(
  model: "Nike Dunk Low Green Glow",
  price: 7,
  size: 38.0,
...
shoe.images.attach(io: file2, filename: 'image2', content_type: 'image/png')
shoe.images.attach(io: file3, filename: 'image3', content_type: 'image/png')
shoe.images.attach(io: file4, filename: 'image4', content_type: 'image/png')
